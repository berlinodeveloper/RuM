...
public class TemplateConfigurationStep extends myStep {
	...
	Set<DataDeclareTemplate> selectedDeclareTemplateSet;
...
//		addRemovePanelLayout.setRowFixed(2, true);
		...
		selectedDeclareTemplateSet = new HashSet<DataDeclareTemplate>();
		
		selectAllButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Object[] allTemplates = templateListPanel.getAllRows().toArray();
				selectedDeclareTemplateSet.clear();
				selectedDeclareTemplateSet.addAll(templateListPanel.getAllDataDeclareTemplates());
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectedDeclareTemplateSet.addAll(templateListPanel.getSelectedDataDeclareTemplates());
		...
		removeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				selectedDeclareTemplateSet.removeAll(templateListPanel.getDataDeclareTemplates(toRemoveTemplateSet));
				selectedTemplatesJList.setListData(templateListPanel.getTemplates(selectedDeclareTemplateSet).toArray());
			}
		});
...
//		part12NCSelectionStepPanel.add(templateSelectionPanel);
	...
	public void readSettings() {
		listener.setSelectedDataDeclareTemplateSet(selectedDeclareTemplateSet);
		//listener.setDeclareTemplateConstraintTemplateMap(declareTemplateConstraintTemplateMap);
		listener.setDataDeclareTemplateConstraintTemplateMap(templateListPanel.getDataDeclareTemplateConstraintTemplateMap());
	}
