...
public class DeclareMinerNoHierarc {
	@UITopiaVariant(affiliation = UITopiaVariant.EHV, author = "F.M. Maggi", email = "F.M.Maggi@tue.nl", uiLabel = "Declare Maps Miner No Hierarchy", pack = "DeclareMiner")
	...
	public static DeclareMinerOutput mineDeclareConstraints(UIPluginContext context, XLog log, DeclareMinerInput input,
		...
		try {
			...
			declareMinerOutput = pruner.fastPrune(false, true, log, input, declareTemplateCandidateDispositionsMap);
			int constraintsNo = 0;
	...
	public static DeclareMinerOutput mineDeclareConstraints(UIPluginContext context, XLog log, DeclareMinerInput input,
		...
		try {
			...
			// declareMinerOutput =
			// pruner.prune(true,frequentItemSetTypeFrequentItemSetSupportMap,
	...
	public static Map<DeclareTemplate, ConstraintTemplate> readConstraintTemplates(
		...
		InputStream templateInputStream = DeclareMinerNoHierarc.class.getResourceAsStream("/resources/template.xml");
