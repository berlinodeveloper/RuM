...
public class DeclareMinerNoTrans {
	@UITopiaVariant(affiliation = UITopiaVariant.EHV, author = "F.M. Maggi", email = "F.M.Maggi@tue.nl", uiLabel = "Declare Maps Miner No Transitive", pack = "DeclareMiner")
	...
	public static DeclareMinerOutput mineDeclareConstraints(UIPluginContext context, XLog log, DeclareMinerInput input,
		...
		try {
			...
			declareMinerOutput = pruner.fastPrune(true, false, log, input, declareTemplateCandidateDispositionsMap);
			int constraintsNo = 0;
	...
	public static Map<DeclareTemplate, ConstraintTemplate> readConstraintTemplates(
		...
		InputStream templateInputStream = DeclareMinerNoTrans.class.getResourceAsStream("/resources/template.xml");
