...
public class GUICustomUtils {
	 ...
	 * be a frame title. The text will be inserted into a gray box.
	 * 
	 * @param s the string to be inserted into the label
	 * @return a component with the required widget
	 */
...
//		labelTitle.setForeground(Color.white);
	...
	/**
	 * This method creates a new {@link JFormattedTextField} for receiving
	 * integer (up to 5 digits) as input
	 * 
	 * @param initialContent the initial content of the text field
	...
	/**
	 * This method creates a new {@link JFormattedTextField} for receiving a
	 * double
	 * 
	 * @param initialContent the initial content of the text field
	...
	/**
	 * This method to wrap a given component into a rounded panel. Example
	 * usage:
	 * <pre>
	...
	/**
	 * Method to convert a value in the interval [0, 1] into a black and white
	 * color, where 0 is white and 1 is black
	 * 
	...
	/**
	 * Method that convert a give color (as "color-base") into another one that
	 * is obtained considering the value as a "weight" (values in [0, 1]). If
	 * the value is 0, the final color will be transparent; if the value is 1,
	 * the final color will be the "color-base"
	 * 
	...
	public static void customizeScrollBard(JScrollPane scroll) {
		SlickerScrollBarUI vertical = new SlickerScrollBarUI(scroll.getVerticalScrollBar(),
				scroll.getBackground(), scroll.getBackground().brighter(), scroll.getBackground().darker(), 3, 12);
		scroll.getVerticalScrollBar().setUI(vertical);
		
		SlickerScrollBarUI horizontal = new SlickerScrollBarUI(scroll.getHorizontalScrollBar(),
				scroll.getBackground(), scroll.getBackground().brighter(), scroll.getBackground().darker(), 3, 12);
